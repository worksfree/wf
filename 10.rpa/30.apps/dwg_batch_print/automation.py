# -*- coding: utf-8 -*-
"""
DWG Batch Print Automation Module
DWG 파일 일괄 인쇄 자동화 모듈
...
class DwgBatchPrintAutomation:
    """DWG 일괄 인쇄 자동화 클래스 (원본 print_DWG_with_tkinter.py 로직 기반)"""
    ...
    def __init__(self, folder_path: Optional[str] = None, console_mode: bool = False):
        ...
        self.logger = get_app_logger("dwg_batch_print", console_level=console_level)
