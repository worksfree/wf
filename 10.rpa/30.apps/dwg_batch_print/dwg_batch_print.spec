...
def load_and_increment_version():
    ...
    settings_file = SPEC_DIR_LOCAL / "config" / "dwg_batch_print" / "settings.json"
...
def bundle_config_files():
    ...
    settings_src = config_base / "dwg_batch_print" / "settings.json"
    ...
    policy_src = config_base / "dwg_batch_print" / "policy.json"
...
def prepare_user_configs():
    ...
    settings_src = app_config_dir / "dwg_batch_print" / "settings.json"
    if settings_src.exists():
